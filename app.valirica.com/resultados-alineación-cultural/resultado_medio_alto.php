...
<div style="display: flex; width: 100%; box-sizing: border-box;">
  ...
  <div style="width: 30%; padding:5px; text-align: center;">
    <!-- Imagen principal -->
    <img src="../uploads/Niveles-3.png" alt="Imagen relacionada" style="max-width:100%; height: auto; margin-bottom: 5px;">
...
<div style="width: 70%; padding-left: 30px;">
  <h1 class="company-info" style="text-align: left; color: #333;">
    <?= $promedio_general ?>% Calificación MEDIA-ALTA </br><a style="color:#FF7800;"> Nivel: FRÆGÐ - Leyend</a>
  </h1>
  ...
  <div style="display: flex; align-items: center; gap: 10px; margin-top: 10px;">
     <img src="../uploads/Niveles-4.png" alt="Siguiente nivel" style="max-width: 100px; height: auto;">
     <p style="font-size: 20px; font-weight: bold; color: #FF7800; margin: 0;">SIGUIENTE </br> NIVEL: </br> <a style="color:#002135">Einherjar</a></p>
...
Tu cultura ya tiene peso. Se siente, se vive y empieza a generar reputación. Tus stakeholders perciben coherencia. </p>
    <div style="display: flex; align-items: left; gap: 10px; margin-top: 10px;">
     ...
     <p style="font-size: 30px; font-weight: bold; color: #002135; margin: 0;">Las leyendas nacen de la coherencia interna. Estás dejando huella.</p>
