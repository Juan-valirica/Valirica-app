...
<div class="botones-section" style="width: 100%;">
    ...
    <!-- Contenido específico para alto -->
<div style="display: flex; width: 100%; box-sizing: border-box;">

    <!-- Columna 1: Imagen + Texto + Imagen -->
  <div style="width: 30%; padding:5px; text-align: center;">
    <!-- Imagen principal -->
    <img src="../uploads/Niveles-4.png" alt="Imagen relacionada" style="max-width:100%; height: auto; margin-bottom: 5px;">
...
<div style="width: 70%; padding-left: 30px;">
  <h1 class="company-info" style="text-align: left; color: #333;">
    <?= $promedio_general ?>% Calificación ALTA </br><a style="color:#FF7800;"> Nivel: EINHERJAR - Worthy</a>
  </h1>
  ...
  <div style="display: flex; align-items: center; gap: 10px; margin-top: 10px;">
     ...
     <p style="font-size: 20px; font-weight: bold; color: #FF7800; margin: 0;">SIGUIENTE </br> NIVEL: </br> <a style="color:#002135">Valhalla</a></p>
...
Has trascendido. Tu cultura inspira. Hay coherencia, propósito y compromiso desde dentro hacia afuera.
    </p>
    <div style="display: flex; align-items: left; gap: 10px; margin-top: 10px;">
     ...
     <p style="font-size: 30px; font-weight: bold; color: #002135; margin: 0;">Eres uno de los elegidos. Tu cultura ya no solo funciona, transforma.</p>
