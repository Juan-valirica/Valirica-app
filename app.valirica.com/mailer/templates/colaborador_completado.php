<?php
/**
 * colaborador_completado.php — Notificación al admin cuando un colaborador
 * completa todo el proceso (formulario_valirica.php + confirmacion_fase2.php).
 *
 * Variables:
...
$titulo    = $nombre_colaborador . ' ha completado su perfil';
$preheader = $nombre_colaborador . ' ha finalizado todo su registro en Valírica. Ya puedes ver su perfil completo.';
...
<p style="margin:0 0 18px;font-size:15px;color:#3d3c3b;line-height:1.7;">
  <strong><?= htmlspecialchars($nombre_colaborador) ?></strong> ha completado exitosamente
  todo su proceso de registro en <strong><?= htmlspecialchars($empresa) ?></strong> en Valírica,
  incluyendo su perfil y cuestionario de cultura.
</p>

<p style="margin:0 0 32px;font-size:15px;color:#3d3c3b;line-height:1.7;">
  Ya puedes consultar su perfil completo y sus resultados desde tu dashboard.
</p>
